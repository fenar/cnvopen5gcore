...
----
(2) Provision user equipment (UE) imsi (see 5gran/templates/5gran-ue-configmap.yaml, defaul imsi is 208930000000001) to 5gcore so your ue registration (ie running ueransim ue mode) will be allowed.
