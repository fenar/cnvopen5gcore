...
(4) Deploy istio manifests and make webui accessible over istio ingress-gw and add your imsi (see ueransim/open5gs-ue.yaml) to system so your ue registration will be allowed.
